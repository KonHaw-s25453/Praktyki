...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CmsApi.ResponseFileDto();
  });
  ...
  describe('ResponseFileDto', function() {
    it('should create an instance of ResponseFileDto', function() {
      // uncomment below and update the code to test ResponseFileDto
      //var instance = new CmsApi.ResponseFileDto();
      //expect(instance).to.be.a(CmsApi.ResponseFileDto);
    });
