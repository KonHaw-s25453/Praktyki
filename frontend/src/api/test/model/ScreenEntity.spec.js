...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CmsApi.ScreenEntity();
  });
  ...
  describe('ScreenEntity', function() {
    it('should create an instance of ScreenEntity', function() {
      // uncomment below and update the code to test ScreenEntity
      //var instance = new CmsApi.ScreenEntity();
      //expect(instance).to.be.a(CmsApi.ScreenEntity);
    });
