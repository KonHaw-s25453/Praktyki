...
Jeśli chcesz, mogę:
- dodać migrację (już przygotowałem `migrations/002_add_cache_versioning.sql`),
- przygotować przykładowy endpoint `/api/v1/screens/manifest` w Node/Express lub Flask,
- wygenerować prosty klient JS/Node który implementuje sync + prefetch.
